...
class SokobanEnv(gym.Env):
    ...
    def __init__(self,
        ...
        self.reward_last = 0  # final reward
    ...
    def step(self, action, observation_mode='rgb_array'):
        assert action in ACTION_LOOKUP  # 斷言action一定屬於ACTION_LOOKUP
        ...
        if action == 0:
            moved_player = False
        else:  # All push actions are in the range of [1, 4]
        '''
        moved_player, moved_box = self._push_or_move(action)
        '''
        else:
    ...
    def _push_or_move(self, action):
        ...
        can_push_box = self.room_state[new_position[0], new_position[1]] in [
            3, 4]
        ...
        if can_push_box:
            ...
            if self.room_fixed[new_box_position[0], new_box_position[1]] == 2:
                box_type = 3
            self.room_state[new_box_position[0],
                            new_box_position[1]] = box_type
            return True, True
        else:  # Try to move if no box to push
    ...
    def _check_if_all_boxes_on_target(self):
        ...
        are_all_boxes_on_targets = np.where(
            empty_targets | player_hiding_target)[0].shape[0] == 0
    ...
    def reset(self, second_player=False, render_mode='rgb_array'):
        ...
        self.num_env_steps = 0  # total steps
        self.reward_last = 0
        self.boxes_on_target = 0
    ...
    def render(self, mode='human', close=None, scale=1):
        ...
        if 'rgb_array' in mode:
            ...
            arr_boxes = ((self.room_state == 4) +
                         (self.room_state == 3)).view(np.int8)
